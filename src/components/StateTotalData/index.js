...
class StateTotalData extends Component {
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo:
        'https://res.cloudinary.com/dwmbbz3pv/image/upload/v1644597326/check-mark_1_mquiyt.svg',
    ...
    const activeData = {
      name: 'Active',
      logo:
        'https://res.cloudinary.com/dwmbbz3pv/image/upload/v1644597526/protection_1_bavqrt.svg',
      value: totalActive,
    }
    ...
    const recoveredData = {
      name: 'Recovered',
      logo:
        'https://res.cloudinary.com/dwmbbz3pv/image/upload/v1644597527/recovered_1_ye9ce4.svg',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo:
        'https://res.cloudinary.com/dwmbbz3pv/image/upload/v1644597527/breathing_1_zkqrob.svg',
      value: totalDeceased,
    }
